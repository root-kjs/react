    ...
    <Box sx={{ width: 320, pl: '24px' }}>
      ...
      >
        ...
        <ListItem sx={{ '--List-gap': '0px' }}>
          <ListItemButton selected>Quick Start</ListItemButton>
        </ListItem>
        <ListItem
          nested
          sx={{ my: 1 }}
        ...
        >
          ...
          {open2 && (
            <List sx={{ '--ListItem-paddingY': '8px' }}>
              <ListItem>
                <ListItemButton>상의</ListItemButton>
              </ListItem>
              <ListItem>
                <ListItemButton>하의</ListItemButton>
              </ListItem>
              <ListItem>
                <ListItemButton>바지</ListItemButton>
              </ListItem>
              <ListItem>
                <ListItemButton>치마</ListItemButton>
              </ListItem>
            </List>
          )}
        </ListItem>
